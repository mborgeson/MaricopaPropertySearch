...
def apply_refresh_fixes():
    ...
    # Define the crash-safe refresh_property_data replacement
    refresh_property_data_fix = '''    def refresh_property_data(self):
...
import traceback
    ...
    # Define the crash-safe _update_dialog_status replacement  
    update_dialog_status_fix = '''    def _update_dialog_status(self):
