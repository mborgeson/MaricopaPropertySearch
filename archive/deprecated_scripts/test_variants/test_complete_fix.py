...
def test_complete_fix():
    ...
    try:
        ...
        try:
            ...
            print(f"   Existing tax records: {len(existing_tax) if isinstance(existing_tax, list) else existing_tax}")
        ...
        try:
            ...
            if api_tax_data and len(api_tax_data) > 0:
                ...
                tax_data = {
                    ...
                    'assessed_value': int(test_record.get('FullCashValue', 0)) if test_record.get('FullCashValue') else None,
                    'limited_value': None,
                    'tax_amount': None,
                    'payment_status': None,
        ...
        try:
            ...
            print(f"   Final tax records: {len(final_tax_records) if isinstance(final_tax_records, list) else final_tax_records}")
            print(f"   Final sales records: {len(final_sales_records) if isinstance(final_sales_records, list) else final_sales_records}")
