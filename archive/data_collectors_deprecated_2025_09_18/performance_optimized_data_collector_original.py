...
class PerformanceOptimizedDataCollector:
    ...
    async def collect_property_data_progressive(
        ...
        try:
            ...
            logger.info(
                f"Progressive collection completed in {results.collection_time:.3f}s for APN: {apn}"
            )
    ...
    async def _collect_detailed_data_fast(
    ...
    async def _collect_extended_data_fast(
