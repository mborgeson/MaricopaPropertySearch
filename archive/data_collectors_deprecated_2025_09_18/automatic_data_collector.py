            ...
            if apn_input:
                ...
                if search_button:
                    ...
                    if tax_records:
                        ...
                        logger.info(
                            f"Collected {len(tax_records)} tax records for APN: {apn}"
                        )
                        ...
                        for tax_record in tax_records:
                            tax_data = {
                                ...
                                "last_payment_date": tax_record.get(
                                    "last_payment_date"
                                ),
                                "raw_data": {
            ...
            if search_input:
                ...
                if search_button:
                    ...
                    if sales_records:
                        ...
                        logger.info(
                            f"Collected {len(sales_records)} sales records for APN: {apn}"
                        )
                        ...
                        for sales_record in sales_records:
                            sales_data = {
                                ...
                                "recording_number": sales_record.get(
                                    "recording_number", ""
                                ),
                            }
