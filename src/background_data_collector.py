...
logger.warning(
    "background_data_collector.py is deprecated. Use unified_data_collector.py instead."
)
...
logger.info(
    "Background data collector: Using unified data collector for background processing"
)
