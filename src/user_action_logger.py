...
class UserActionLogger:
    ...
    def __init__(self, log_dir: str = None):
        ...
        self.log_file = self.log_dir / f"user_actions_{self.session_start.strftime('%Y%m%d_%H%M%S')}.jsonl"
    ...
    def log_action(self, action_type: str, details: Dict[str, Any], 
                   user_input: Optional[str] = None, result: Optional[str] = None,
    ...
    def log_collect_data(self, apn: str, data_type: str = "all", success: bool = True):
        ...
        self.log_action(
            ...
            result="Data collected successfully" if success else "Data collection failed"
        )
