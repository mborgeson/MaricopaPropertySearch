...
logger.warning(
    "automatic_data_collector.py is deprecated. Use unified_data_collector.py instead."
)
...
class MaricopaDataCollector:
    ...
    def __init__(self, db_manager):
        ...
        logger.info(
            "MaricopaDataCollector: Using unified data collector for automatic data collection"
        )
