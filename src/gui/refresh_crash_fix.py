#!/usr/bin/env python
"""
CRASH-SAFE REFRESH BUTTON FIX for Maricopa Property Search Application

This script contains the fixed refresh_property_data function to replace the crash-prone version.
Apply this fix to enhanced_main_window.py line 1082.
"""
...
# Additional safety improvements for the _update_dialog_status method
def _update_dialog_status_safe(self):
...
"""
APPLY THIS FIX TO enhanced_main_window.py:

1. Replace the existing refresh_property_data function (around line 1082) with refresh_property_data above
2. Replace the existing _update_dialog_status function (around line 1135) with _update_dialog_status_safe above  
...
- Progress dialog resource leaks
"""