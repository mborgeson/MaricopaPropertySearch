...
logger.warning("improved_automatic_data_collector.py is deprecated. Use unified_data_collector.py instead.")
...
class ImprovedMaricopaDataCollector:
    ...
    def __init__(self, db_manager, api_client):
        ...
        logger.info("ImprovedMaricopaDataCollector: Using unified data collector for comprehensive data collection")
    ...
    def collect_data_for_apn_sync(self, apn: str):
        ...
        """
        logger.info(f"Improved automatic data collection (via unified collector) for APN: {apn}")
