    ...
    try:
        ...
        if property_record:
            ...
            if missing_fields:
                ...
                if success:
                    print(
                        "  [+] Successfully updated property record with complete data"
                    )
                else:
        ...
        print(
            f"[+] Property Record: {'Complete' if updated_property.get('owner_name') else 'Missing Data'}"
        )
        print(
            f"[+] Tax History: {len(updated_tax)} records with proper assessed values"
        )
