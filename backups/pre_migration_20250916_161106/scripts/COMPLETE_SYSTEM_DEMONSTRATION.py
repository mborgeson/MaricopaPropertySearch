...
def complete_system_demonstration():
    ...
    try:
        ...
        has_auto_collection = hasattr(
            api_client, "get_complete_property_with_automatic_data_collection"
        )
        print(
            f"   Enhanced API Client: {'READY' if has_auto_collection else 'NOT AVAILABLE'}"
        )
