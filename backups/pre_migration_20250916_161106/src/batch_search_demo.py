...
def demonstrate_batch_search():
    ...
    try:
        ...
        for i, demo in enumerate(demos, 1):
            ...
            try:
                ...
                if results:
                    ...
                    print(f"  Average per Item: {results.average_time_per_item:.2f} seconds")
                    ...
                    if results.results:
                        ...
                        for result in results.results[:2]:  # Show first 2
                            ...
                            print(f"    {status_icon} {result.identifier}: {result.error_message or 'Success'}")
                else:
        ...
        print(f"Average Throughput: {stats['average_throughput_items_per_second']:.2f} items/sec")
        ...
        if 'batch_search_engine' in stats:
            ...
            print(f"  Connection Pool Size: {engine_stats.get('connection_pool_size', 0)}")
            print()
