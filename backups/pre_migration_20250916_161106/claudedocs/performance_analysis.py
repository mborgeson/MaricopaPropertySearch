...
def analyze_api_performance():
    ...
    try:
        ...
        endpoints_to_test = [
            ...
            ("Search All Property Types", lambda: api_client.search_all_property_types(apn, limit=1)), 
...
def analyze_database_performance():
    ...
    try:
        ...
        operations = [
            ...
            ("Address Search", lambda: db_manager.search_properties_by_address("Missouri", limit=10))
        ]
