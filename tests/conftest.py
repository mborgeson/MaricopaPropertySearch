...
@pytest.fixture
    ...
    return {
        ...
        "coordinates": {"latitude": 33.5806, "longitude": -112.2839},
        "last_sale": {
            "date": "2020-05-15",
            "price": 275000,
...
@pytest.fixture
    ...
    return {
        ...
        "api_error": {"status_code": 500, "json": {"error": "Internal server error"}},
        "rate_limited": {"status_code": 429, "json": {"error": "Rate limit exceeded"}},
        "not_found": {"status_code": 404, "json": {"error": "Property not found"}},
    }
