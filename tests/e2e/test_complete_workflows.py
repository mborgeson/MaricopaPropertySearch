...
class TestCompleteUserWorkflows:
    ...
    def app_process(self):
        ...
        # Start application
        app_path = Path(__file__).parent.parent.parent / "src" / "maricopa_property_search.py"
    ...
    def test_power_user_rapid_search_workflow(self, app_process):
        ...
        for search_type, term in search_sequences:
            ...
            assert search_time < 2.0, f"Search for {term} took {search_time:.2f}s, too slow for power user"
    ...
    def _simulate_network_failure_recovery(self):
        ...
        assert recovery_time < 10.0, "Network recovery enhancement should complete quickly"
...
class TestVisualRegression:
    ...
    def test_loading_state_appearance(self):
        ...
        for state in loading_states:
            ...
            assert appearance_professional, f"Loading state {state} should appear professional"
